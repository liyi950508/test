...
<html>
	...
	<head>
		...
		<link type="text/css" rel="stylesheet" href="css/UpandDownResource/downResource.css" />
			...
			<div class="middle-page">
				<div class="sort">
					<div class="sort-item">
						<ul>
							<li>
								<a class="sort-item-cont" href="resourceAction_showAllByPage">全部资源</a>
							</li>
							<li>
								<a class="sort-item-cont" href="resourceAction_showAllByPage?label=课件ppt">课件ppt</a>
							</li>
							<li>
								<a class="sort-item-cont" href="resourceAction_showAllByPage?label=教辅文档">教辅文档</a>
							</li>
							<li>
								<a class="sort-item-cont" href="resourceAction_showAllByPage?label=期刊杂志">期刊杂志</a>
							</li>
							<li>
								<a class="sort-item-cont" href="resourceAction_showAllByPage?label=源码">源码</a>
							</li>
							<li>
								<a class="sort-item-cont" href="resourceAction_showAllByPage?label=其他">其他</a>
							</li>
						</ul>
					</div>
					<div class="wrap-a">
						<div class="orderby">
							<ul>
								<li class="lesson-new">
									<a class="type-title" href="resourceAction_showAllByPage?<%String l = (String)request.getAttribute("label");if(l != null){%>label=<%=l%>&<%}%>orderby=uploadTime">最新</a>
								</li>
								<li class="lesson-new">
									<a class="type-title" href="resourceAction_showAllByPage?<%if(l != null){%>label=<%=l%>&<%}%>orderby=downloadNumber">最热</a>
								</li>
							</ul>
						</div>
						<p>
							<%if(l != null){%><%=l%>&nbsp;/&nbsp;<%}%><%=(String)request.getAttribute("order") %></p>
					</div>
				</div>
				...
				<div class="feiye-nav">
					<ul>
						<c:choose>
							...
							<c:otherwise>
								<li>
									<a class="a-cont" href="resourceAction_showAllByPage?currentPage=1">«首页</a>
								</li>
								<li>
									<a class="a-cont" href="resourceAction_showAllByPage?currentPage=${pageBean.currentPage-1}">«上一页</a>
								</li>
							</c:otherwise>
						</c:choose>
						...
						<c:forEach begin="${pageBean.forEachBegin }" end="${pageBean.forEachEnd}" varStatus="tp">
							<c:choose>
								...
								<c:otherwise>
									<li>
										<a class="a-cont" href="resourceAction_showAllByPage?currentPage=${tp.index}">${tp.index}</a>
									</li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						...
						<c:choose>
							<c:when test="${pageBean.currentPage!=pageBean.totalPage}">
								<li>
									<a class="a-cont" href="resourceAction_showAllByPage?currentPage=${pageBean.currentPage+1}">下一页»</a>
								</li>
								<li>
									<a class="a-cont" href="resourceAction_showAllByPage?currentPage=${pageBean.totalPage}">尾页»</a>
								</li>
							</c:when>
							<c:otherwise>
								<li>
