! function(n) {
	...
	function i(n) {
		if(!p && ("onreadystatechange" !== n.type || "complete" === document.readyState)) {
			(new s).init(), p = !0
		}
	}
	...
	var a = e(0),
		...
		s = function() {
			...
			return r(n, [{
				...
				key: "nologin",
				value: function() {
					return this.parseDom('<span class="userinfo-notlogin">\n                       <a href="//passport.jikexueyuan.com/sso/login">登录</a><i></i><a href="//passport.jikexueyuan.com/sso/reg_phone">注册</a>\n                       </span>')[0]
				}
			}, {
				key: "logined",
				value: function() {
					var n = this.getCookie("domain"),
						t = this.getCookie("uuid"),
						e = '<span class="userinfo-login" id="userinfo-login">\n                        <a href="//my.jikexueyuan.com/setting/user/">\n                            <img src="" id="userpoto">\n                        </a>\n                        <i id="uservip-icon"></i>\n                        <div class="slide-submeu user-slide">\n                                <a href="//xue.jikexueyuan.com/"><i class="learningcenter-icon"></i>学习中心</a>\n                                <a href="//my.jikexueyuan.com/' + (n || t) + '"><i class="homepage-icon"></i>个人主页</a>\n                                <a href="//my.jikexueyuan.com/setting/user/"><i class="set-icon"></i>账号设置</a>\n                                <a href="//passport.jikexueyuan.com/submit/logout"><i class="exit-icon"></i>退出登录</a>\n                        </div>\n                    </span>';
					return this.parseDom(e)[0]
				}
			}, {
				key: "getUserLevel",
				value: function() {
					var n = this.getCookie("is_expire"),
						t = this.getCookie("vip_status"),
						e = this.getCookie("svip_status"),
						o = this.getCookie("svip_is_expire"),
						i = document.getElementById("uservip-icon");
					1 == e ? 0 == o && (i.className = "svip-icon") : 1 == t && 0 == n && (i.className = "vip-icon")
				}
			}, {
				key: "parseDom",
				value: function(n) {
					var t = document.createElement("div");
					return t.innerHTML = n, t.childNodes
				}
			}, {
				key: "getavatar",
				value: function() {
					var n = this.getCookie("avatar"),
						t = document.getElementById("userpoto");
					void 0 !== n && "" != n ? t.setAttribute("src", n) : t.setAttribute("src", "//s1.jikexueyuan.com/index/images/headpic_8ce0f6d.jpg")
				}
			}, {
				key: "state",
				value: function() {
					var n = this.getCookie("authcode");
					if(void 0 == n || "" == n) {
						var t = document.getElementById("nav-other"),
							e = this.nologin();
						t.appendChild(e)
					} else {
						var o = document.getElementsByClassName("centerbox")[0],
							i = document.getElementsByClassName("centerbox")[1];
						o.style.display = "inline-block", i.style.display = "inline-block";
						var t = document.getElementById("nav-other"),
							a = this.logined();
						t.appendChild(a), this.getUserLevel(), this.getavatar(), this.getmessage()
					}
				}
			}, {
				key: "getQueryString",
				value: function() {
					...
					null !== n && (document.getElementById("searchinput").value = n)
				}
			}, {
				key: "search",
				value: function() {
					function n(n) {
						var t = l.value;
						"" != t && (location.href = x + t), event.stopPropagation()
					}

					function t(t) {
						l === document.activeElement && 13 == t.keyCode && n()
					}

					function e(n) {
						n.stopPropagation();
						var t = d(n.target.value);
						if("" === t) return void(u.innerHTML = "");
						k = n.timeStamp;
						setTimeout(function() {
							k - n.timeStamp == 0 && o(t)
						}, 500)
					...
					function o(n) {
						m.ajax({
							url: "//search.jikexueyuan.com/api/1/search/courselist",
							jsonp: "jsoncallback",
							data: {
								q: n
							},
							success: function(t) {
								200 === t.code && t.data.length > 0 && (u.className = h + " keyup", u.innerHTML = r(t.data, n), f.className = g + " active")
							}
						})
					}

					function i(n) {
						if(n.stopPropagation(), "" !== d(l.value)) return void o(d(l.value));
						b || (b = !0)
					}

					function a(n) {
						b = !1, f.className = g, n.stopPropagation()
					}
					...
					function r(n, t) {
						...
						return n.forEach(function(n) {
							var o = "",
								i = n.title;
							"path" === n.type ? o = "label-blue" : "pro" === n.type ? o = "label-green" : "xilie" === n.type && (o = "label-purple");
							var a = p(i, t);
							"" !== a && (i = s(i, a)), e += '<a href="//' + n.link_url + '">' + i + '<span class="label ' + o + '" style="' + ("" === n.tag ? "display:none" : "") + '">' + n.tag + "</span></a>"
						}), e
					}

					function s(n, t) {
						return n.replace(new RegExp(t, "gi"), '<span style="color:#35b558">' + t + "</span>")
					}
					...
					var c = document.getElementById("search-bottom"),
						l = document.getElementById("searchinput"),
						u = document.getElementsByClassName("search-result")[0],
						h = u.className,
						f = document.getElementsByClassName("search")[0],
						g = f.className,
						x = "//search.jikexueyuan.com/course/?q=",
						m = this,
						k = 0,
						b = !1;
					c.onclick = n, f.onclick = i, document.addEventListener ? (l.addEventListener("keydown", t, !1), l.addEventListener("keyup", e, !1), document.addEventListener("click", a, !1)) : document.attachEvent && (l.attachEvent("onkeydown", t), l.attachEvent("onkeyup", e), document.attachEvent("onclick", a))
				}
			}, {
				key: "getmessage",
				value: function() {
					document.getElementById("have").style.display = "none", this.ajax({
						url: "//www.jikexueyuan.com/message/v1/unread/",
						jsonp: "jsoncallback",
						data: {
							aid: this.getCookie("aid") || 1,
							uid: this.getCookie("uid"),
							type: "jsonp"
						},
						success: function(n) {
							200 == n.code && n.data.unread_num > 0 && (document.getElementById("have").style.display = "block")
						},
						error: function(n) {
				...
				value: function(n) {
					function t(n) {
						var t = [];
						for(var o in n) t.push(encodeURIComponent(o) + "=" + encodeURIComponent(n[o]));
						return t.push("v=" + e()), t.join("&")
					}
					...
					n = n || {}, n.data = n.data || {};
					var o = n.jsonp ? function(n) {
						var e = n.jsonp,
							o = document.getElementsByTagName("head")[0];
						n.data.callback = e;
						var i = t(n.data),
							a = document.createElement("script");
						o.appendChild(a), window[e] = function(t) {
							o.removeChild(a), clearTimeout(a.timer), window[e] = null, n.success && n.success(t)
						}, a.src = n.url + "?" + i, n.time && (a.timer = setTimeout(function() {
							window[e] = null, o.removeChild(a), n.error && n.error({
								message: "超时"
							})
						}, time))
					}(n) : o(n)
				...
				key: "jkxyid",
				value: function() {
					for(var n = [], t = "0123456789abcdef", e = 0; e < 36; e++) n[e] = t.substr(Math.floor(16 * Math.random()), 1);
					return n[14] = "4", n[19] = t.substr(3 & n[19] | 8, 1), n[8] = n[13] = n[18] = n[23] = "-", n.join("")
				}
			}, {
				key: "setCookie",
				value: function(n, t) {
					var e = new Date;
					return e.setTime(e.getTime() + 31104e6), document.cookie = [n + "=" + escape(t), "; expires=" + e.toGMTString(), ";path=/", ";domain=.jikexueyuan.com"].join("")
				}
			}, {
				key: "setJkxyId",
				value: function() {
					var n = this.jkxyid(),
						t = this.getCookie("jkxyid_v2");
					void 0 != t && "" != t && null != t || this.setCookie("jkxyid_v2", n)
				}
			}, {
				key: "getTopBanner",
				value: function() {
					...
					$.ajax({
						type: "get",
						url: t + "ad.jikexueyuan.com/v1/code_slot_slug/commonheadertopnotice/delivery?params=" + JSON.stringify(n),
						data: "",
						dataType: "json",
						success: function(n) {
							200 == n.code && "成功" == n.msg && n.data.forEach(function(n) {
								if(21 == n.code_slot_id && n.creatives.length > 0) {
									var t = 1 == n.creatives[0].target ? "_blank" : "",
										e = "" !== n.creatives[0].url ? n.creatives[0].url : "javascript:;",
										o = '<a href="' + e + '" target="' + t + '"><p><span>' + n.creatives[0].text + '</span><i class="close-notice"></i></p></a>';
									$("#header_top_notice").append(o)
								}
							}), $("#header_top_notice").slideDown(), setTimeout(function() {
								$("#header_top_notice").slideUp()
							}, 3e4)
						},
						error: function() {}
					})
	...
	function i(n, t) {
		for(var e = [], o = {}, i = 0; i < n.length; i++) {
			...
			o[r] ? o[r].parts.push(c) : e.push(o[r] = {
				id: r,
				parts: [c]
			})
		}
	...
	function s(n) {
		...
		return n.attrs.type = "text/css", d(t, n.attrs), a(n, t), t
	}

	function p(n) {
		var t = document.createElement("link");
		return n.attrs.type = "text/css", n.attrs.rel = "stylesheet", d(t, n.attrs), a(n, t), t
	}
	...
	function c(n, t) {
		...
		if(t.singleton) {
			var d = k++;
			e = m || (m = s(t)), o = l.bind(null, e, d, !1), i = l.bind(null, e, d, !0)
		} else n.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (e = p(t), o = h.bind(null, e, t), i = function() {
			r(e), e.href && URL.revokeObjectURL(e.href)
		}) : (e = s(t), o = u.bind(null, e), i = function() {
			r(e)
		});
		return o(n),
			function(t) {
	...
	function l(n, t, e, o) {
		var i = e ? "" : o.css;
		if(n.styleSheet) n.styleSheet.cssText = y(t, i);
		else {
	...
	function h(n, t, e) {
		...
		(t.convertToAbsoluteUrls || a) && (o = v(o)), i && (o += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(i)))) + " */");
		var r = new Blob([o], {
				type: "text/css"
			}),
			s = n.href;
	...
	n.exports = function(n) {
		...
		return n.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(n, t) {
			...
			var a;
			return a = 0 === i.indexOf("//") ? i : 0 === i.indexOf("/") ? e + i : o + i.replace(/^\.\//, ""), "url(" + JSON.stringify(a) + ")"
		})
	}
}]);